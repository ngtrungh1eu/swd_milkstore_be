...
namespace BussinessLogic.Service
{
    public interface IBlogService
    {
        ...
        Task<ServiceResponse<BlogDTO>> UpdateBlog(BlogDTO blog, int userId);
    ...
    public class BlogService : IBlogService
    {
        ...
        async Task<ServiceResponse<BlogDTO>> IBlogService.UpdateBlog(BlogDTO blog, int userId)
        {
            ...
            try
            {
                ...
                if (!await _blogRepository.UpdateBlog(existingBlog))
                {
                    _response.Success = false;
                ...
                var blogDto = _mapper.Map<BlogDTO>(existingBlog);
                _response.Success = true;
